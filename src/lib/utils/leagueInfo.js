...
export const homepageText = `
  <p>The unofficial page to see Brendan Flatley & the pope's fav christians (new pope, whaddup) fantasy football domination over the years.</p>
...
export const managers = [
    ...
    //  "tookOver": 2020, // (DEPRECATED! You don't need to use this anymore) (optional) used if a manager took over a team, delete this line or change to null otherwise
      ...
      "bio": "Cool as fuck, loves the game, and is a great guy. Also, I have a great sense of humor and am very humble",
